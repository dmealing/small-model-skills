...
smaller tool surface. Opt out with `SMOLS_CURATED_SKILLS=0`.
...
with a small, clean context than with your full frontier-model setup. Set `SMOLS_CURATED_SKILLS=0` to run
