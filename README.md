...
fix for you to run. `claude-local` runs with normal Claude Code permission prompts (no
`--dangerously-skip-permissions`) — your existing `~/.claude/settings.json` allow/deny/ask rules apply.
